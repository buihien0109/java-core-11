...
import vn.techmaster.service.EmployeeService;
...
public class EmployeeController {
        ...
        while (isContinue) {
            ...
            switch (option) {
                ...
                case 3 : {
                    ...
                    if(employees.isEmpty()) {
                        System.out.println("Không có nhân viên có tên là " + name + " trong danh sách");
                    } else {
                ...
                case 6 : {
                    ...
                    if(employees.isEmpty()) {
                        ...
                        System.out.println("Nhân viên có có mức lương từ 5.000.000 -> 10.000.000 bao gồm:");
                        employeeService.printInfo(employees);
                    }
                    break;
                }
    ...
    private void printMenu() {
        System.out.println("\n*********** MENU ***********");
        System.out.println("1. In thông tin nhân viên");
